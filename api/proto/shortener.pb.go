...
const file_api_proto_shortener_proto_rawDesc = "" +
	"\n" +
	"\x19api/proto/shortener.proto\x12\x17url_shortener.api.proto\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x10UserURLsResponse\x122\n" +
	"\x03url\x18\x01 \x03(\v2 .url_shortener.api.proto.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xb0\x02\n" +
	"\x10ShortenerService\x12e\n" +
	"\n" +
	"ShortenURL\x12*.url_shortener.api.proto.URLShortenRequest\x1a+.url_shortener.api.proto.URLShortenResponse\x12b\n" +
	"\tExpandURL\x12).url_shortener.api.proto.URLExpandRequest\x1a*.url_shortener.api.proto.URLExpandResponse\x12Q\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a).url_shortener.api.proto.UserURLsResponseB4Z2github.com/DNA-Z/url-shortener/api/proto;shortenerb\x06proto3"
...
var file_api_proto_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: url_shortener.api.proto.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: url_shortener.api.proto.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: url_shortener.api.proto.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: url_shortener.api.proto.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: url_shortener.api.proto.UserURLsResponse
	(*URLData)(nil),            // 5: url_shortener.api.proto.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_api_proto_shortener_proto_depIdxs = []int32{
	5, // 0: url_shortener.api.proto.UserURLsResponse.url:type_name -> url_shortener.api.proto.URLData
	0, // 1: url_shortener.api.proto.ShortenerService.ShortenURL:input_type -> url_shortener.api.proto.URLShortenRequest
	2, // 2: url_shortener.api.proto.ShortenerService.ExpandURL:input_type -> url_shortener.api.proto.URLExpandRequest
	6, // 3: url_shortener.api.proto.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: url_shortener.api.proto.ShortenerService.ShortenURL:output_type -> url_shortener.api.proto.URLShortenResponse
	3, // 5: url_shortener.api.proto.ShortenerService.ExpandURL:output_type -> url_shortener.api.proto.URLExpandResponse
	4, // 6: url_shortener.api.proto.ShortenerService.ListUserURLs:output_type -> url_shortener.api.proto.UserURLsResponse
